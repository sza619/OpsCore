...
export const Roles = () => {
  ...
  const permissionsByCategory = (permissionsData || []).reduce((acc: any, permission: Permission) => {
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600 mt-1">Manage access control and permissions</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="space-y-4">
          <h2 className="text-xl font-semibold text-gray-900">Available Permissions</h2>
